...
| [安装桌面环境或窗口管理器](./wiki/archlinux/安装桌面环境或窗口管理器.md) | - [选择安装桌面环境或窗口管理器](./wiki/archlinux/安装桌面环境或窗口管理器.md#主要分类)<br>- [一键配置桌面环境](./wiki/archlinux/一键配置桌面环境.md)<br>- [安装GNOME](./wiki/archlinux/安装GNOME.md)<br>- [安装KDE Plasma](./wiki/archlinux/安装KDE.md)<br>- [安装Niri](./wiki/archlinux/安装Niri.md)<br>- [安装Labwc](./wiki/archlinux/安装Labwc.md) |
